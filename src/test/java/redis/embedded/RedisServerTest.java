    ...
    RedisExecProvider customProvider =
        RedisExecProvider.defaultProvider()
            .override(
                OS.UNIX,
                Architecture.x86,
                Resources.getResource("redis-server-4.0.10-32").getFile())
            .override(
                OS.UNIX,
                Architecture.x86_64,
                Resources.getResource("redis-server-4.0.10").getFile())
            // TODO                .override(OS.WINDOWS, Architecture.x86,
            // Resources.getResource("redis-server-4.0.10.exe").getFile())
            // TODO                .override(OS.WINDOWS, Architecture.x86_64,
            // Resources.getResource("redis-server-4.0.10.exe").getFile())
